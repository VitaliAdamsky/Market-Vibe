...
@Component({
  selector: 'app-mini-sentiment-heatmap',
  templateUrl: './mini-sentiment-heatmap.component.html',
  styleUrls: ['./mini-sentiment-heatmap.component.css'],
})
export class MiniSentimentHeatmapComponent implements OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (this.dichotomicMetrics.includes(this.metricKey)) {
      this.heatmapData = generateDichotomicHeatmap(this.data, this.metricKey);
    }
  }
